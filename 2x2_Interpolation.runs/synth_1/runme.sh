...
HD_PWD='C:/workspace/ImageProcessing/2x2_Interpolation/2x2_Interpolation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_interpolation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_interpolation.tcl
